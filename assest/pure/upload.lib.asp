...
Const MaxLicensedLimit = &H77359400 ' Tamanho m�ximo do upload para qualquer situa��o = 2 GB (limite do IIS).
Class ASPForm
...
Class cProgressFile
 ...
 End Property
 Public Sub Done 'Remove arquivo tempor�rio quando alcan�a sucesso no upload.
